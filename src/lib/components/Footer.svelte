<footer class="container flex sm:flex-row flex-col justify-between items-center mb-8 sm:mb-4 h-[130px] sm:h-[123px]">
            ...
            <div class="grid grid-cols-4 gap-4">
                ...
                <a
                    aria-label="Social Media"
                    href="https://twitter.com/Himanshu_76200/"
                    target="_blank"
                    class="footer-icons border border-white p-3 rounded-md text-white"
                >
                    <svg
                ...
                <a
                    aria-label="Social Media"
                    href="mailhref:himanshu76200@gmail.com"
                    target="_blank"
                    class="footer-icons border border-white p-3 rounded-md text-white"
                >
                    <svg
